...
public class SmartAppSelectorServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		...
		System.out.println("smartAppLaunchURL " + smartAppLaunchURL);
		String url = smartAppLaunchURL
		        + "?iss=http://localhost:8080/openmrs/ws/fhir2/R4&launch=808a7c73-404e-4444-9b4b-c06d4b6f0f45";
